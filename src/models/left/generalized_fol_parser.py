...
from concepts.dsl.dsl_types import BOOL, INT64, ObjectType, Variable
from concepts.dsl.expression import (AndExpression,
                                     FunctionApplicationExpression,
                                     GeneralizedQuantificationExpression,
                                     OrExpression, ValueOutputExpression,
                                     get_expression_definition_context,
                                     get_types)
