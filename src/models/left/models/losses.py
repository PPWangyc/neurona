...
from models.left.models.reasoning.reasoning import NCOneTimeComputingGrounding
from models.left.nn.losses import MultitaskLossBase
            ...
            if result_typename == 'bool':
                if isinstance(gt_answer, str):
                    if gt_answer in ['yes', 'no']:
                        gt_answer = gt_answer == 'yes'
                if isinstance(gt_answer, bool) or isinstance(gt_answer, torch.Tensor):
